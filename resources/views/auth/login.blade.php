        ...
        <div class="login-page">
            ...
            <aside class="login-side">
                ...
                <div class="mascot-wrap">
                    <img src="{{ asset('img/LogoSemFundo.png') }}" alt="Logo LumiKids" class="mascot-star">
                </div>

                <h1 class="brand-title">Lumi<span class="accent">Kids</span></h1>
                <p class="brand-subtitle">Sistema de<br>Educação Infantil</p>

                <div class="illustration-cloud"></div>

                <div class="illustration-blocks">
                    <img src="{{ asset('img/Blocos.png') }}" alt="Blocos coloridos empilhados" class="blocks-image">
                </div>
            </aside>
