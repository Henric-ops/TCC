...
<body>
    <main class="register-card">
        <div class="logo-wrap">
            <img src="{{ asset('img/LogoLogin.png') }}" alt="Logo LumiKids" class="register-logo">
        </div>
        ...
        <form method="POST" action="{{ route('register.store') }}">
            ...
            <div class="field">
                ...
                <input type="text" id="nome" name="nome" value="{{ old('nome') }}" placeholder="Seu nome completo" required>
            </div>
            ...
            <div class="field-row">
                ...
                <div class="field">
                    ...
                    <input type="password" id="senha_confirmation" name="senha_confirmation" placeholder="Repita a senha" required>
                </div>
            </div>
